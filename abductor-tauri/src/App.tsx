...
export default function App() {
  ...
  // Stable identity across renders (App re-renders every 2.4s from the joke
  // rotation timer below, even during "idle") — an inline arrow here would
  // reset Splash's effect on every one of those renders and never let its
  // message sequence finish.
